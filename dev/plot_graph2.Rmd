...
DF <- txt |> extract_graph_rb() #|> count_graphs()
c(DF$n1, DF$n2) |> unique() |> grep(x=_, "_", value=F)
...
Replace the _ in nodes, as extracted by extrac_graph_rb()
#' @param text_ws FALSE. If some nodes contains white space, replace it with underline.
```{r gsub _ }
