...
```
```{r read_html wiki_Hurricane_Milton.html,  echo=FALSE, eval=T}
...
(g_Ob + g_Tr) +
   plot_annotation(
  title = paste('Coocurrence of terms in the phrases that contains term: "', term, '"') )
```
