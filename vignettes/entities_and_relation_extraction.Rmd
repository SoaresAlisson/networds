...
- the user can specify a connector, like "of"or "of the" so, words like "United States of America" or "Covid-19" are also captured
...
my_sw <- c(stopwords::stopwords(language = "en", 
  source = "snowball", simplify = TRUE), "lol")
...
Is possible to use grammar classification to get more precise results.
