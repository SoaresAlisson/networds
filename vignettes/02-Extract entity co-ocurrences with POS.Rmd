...
The {txtnet} comes with this text sample. In this tutorial, we will different parts of the text to a better visualization.
...
Visualizing the graph. (the nodes can become in a crazy dance to find the best distance between themselves)
